...
class SecuritySummaryAdapter(
    private val viewModel: SummaryViewModel,
    private val dateFormat: DateFormat
) :
    ListAdapter<SecuritySummary, SecuritySummaryAdapter.ViewHolder>(SecuritySummaryDiffCallback()) {
    ...
    class ViewHolder private constructor(private val binding: SecuritySummaryItemBinding) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = SecuritySummaryItemBinding.inflate(layoutInflater, parent, false)
